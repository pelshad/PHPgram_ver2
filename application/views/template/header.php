                    ...
                    <nav class="d-flex flex-grow-1 flex-row justify-content-end">
                        ...
                        <div class="d-inline-flex dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navDropdownMenuLink">
                                <li>
                                    <a class="dropdown-item" href="#" data-bs-target="#profileModal" id="btnNewFeedModal" data-bs-toggle="modal">
            ...
            <div class="modal-body">
                <form><!--js로 파일첨부 창 열리게 하기-->
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="intro"><?=getLoginUser()->intro?></textarea>
                    </div>
